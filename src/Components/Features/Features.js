const Features = () => {
    let Features=[
        ...
        },
        {
            ...
            desc:"Maximize Engagement: Enhance user interaction and earn rewards through our recommendation system.",
        },
        {
    ...
    <section className='md:pt-24 md:pb-40  py-6 bg-[#f7f7f7]'>
        <div className='max-w-screen-xl md:px-[90px] sm:px-24 px-4 m-auto'>
            <div className='details flex flex-col justify-center items-center gap-7'>
                <span className='font-medium text-xl text-[#E93439] '>Features</span>
                <h2 className='font-bold md:text-5xl text-3xl text-center text-[#191C29]'>
                    Unlock the Power of 
                    <span className='text-[#E93439]'> Doofdi </span> 
                    Today
                </h2>
            ...
            <div className='cards mt-16'>
                <div className='cards-container flex flex-wrap md:gap-y-9 md:gap-x-4 gap-11 justify-between md:justify-center '>
                    {
                        Features.map((feature,indx)=>{
                            return(
                                <div key={indx} className='card flex flex-col items-center  lg:w-[23.90%] md:[25%] sm:w-[40%] rounded-[10px] w-full py-6 px-3 bg-[#FFFFFF]'>
                                    <div className='icon w-[115px] mb-[19px] '>
                                        <img className='w-full' src={feature.image} alt="" />
                                    </div>
                                    <div className='flex  flex-col '>
                                        <h1 className='text-xl font-medium text-center mb-[21px]'>{feature.title}</h1>
                                        <p className='font-normal text-sm text-center text-[#667986] '>{feature.desc}</p>
                                    </div>
                                </div>
                            )
                        })
