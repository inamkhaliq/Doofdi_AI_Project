        ...
        <section className='py-20 bg-[#F2F2F2]'>
            <div className='max-w-screen-xl md:px-[90px] sm:px-24 px-4 m-auto '>
                <div className='details'>
                    <h1 className='text-center font-bold md:text-5xl text-3xl md:mb-8 mb-3'>How <span className='text-[#CB5846]'>Doofdi</span> Works</h1>
                ...
                <div className='cards md:mt-28 mt-6'>
                    <div className='cards-container flex flex-wrap gap-x-9 md:gap-y-16 gap-y-7 justify-between '>
                        {
                            Points.map((point,indx)=>{
                                return(
                                    <div key={indx} className='card md:w-[22%] sm:w-[33%] w-full'>
                                        <h1 className='font-bold text-[64px] md:leading-[77px] text-center'>{`0${indx+1}.`}</h1>
                                        <p className='font-medium text-xl text-center md:mt-4 md:mb-5'>{point.title}</p>
                                        <p className='text-sm font-normal text-center'>{point.desc}</p>
                                    </div>
                                )
                            })
                        }
